...
const quickLinks = [
  ...
  { href: "/colour-safety", icon: "heart", label: "Colour Safety", color: "from-red-500/30 to-red-600/10 border-red-500/30" },
  { href: "/checklist", icon: "star", label: "Checklist", color: "from-yellow-500/30 to-yellow-600/10 border-yellow-500/30" },
  { href: "/emergency", icon: "shield", label: "Emergency", color: "from-teal-500/30 to-teal-600/10 border-teal-500/30" },
];
